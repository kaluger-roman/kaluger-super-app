...
export const studentAuthApi = {
  registerByInvite: async (data: StudentRegisterByInviteRequest): Promise<StudentAuthResponse> => {
    const response = await publicApi.post("/student-auth/register", data);
  ...
  verifyEmail: async (code: string): Promise<StudentSession> => {
