...
export const isProspectLesson = (lesson: Pick<Lesson, "studentId">): boolean => !lesson.studentId;

export const getLessonDisplayName = (lesson: Pick<Lesson, "student" | "prospectName">): string =>
