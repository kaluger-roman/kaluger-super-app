...
test.describe("Невалидная инвайт-ссылка ученика", { tag: ["@regression", "@auth"] }, () => {
  test("ученик открывает ссылку с неизвестным токеном и видит сообщение", async ({ page }) => {
  ...
  test("ученик открывает уже использованную ссылку и видит сообщение", async ({ page }) => {
