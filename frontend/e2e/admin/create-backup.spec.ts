...
import { clearBackupFiles, issueAdminToken, seedAdminAuthInBrowser } from "../helpers/auth";

test.describe("Ручное создание бэкапа БД", { tag: ["@regression", "@admin"] }, () => {
  test("админ нажимает «Создать бэкап» и видит новый файл в списке", async ({ page }) => {
