...
test.describe("Удаление серии регулярных уроков", { tag: ["@regression", "@lessons"] }, () => {
  test("учитель удаляет повторяющийся урок со всеми будущими повторами серии", async ({
    ...
    await deleteDialog.getByLabel("Удалить все запланированные повторы этого урока").check();
