...
test.describe("Push-подписка на напоминания об уроках", { tag: ["@regression", "@pwa"] }, () => {
  ...
  test.skip("учитель включает напоминания — подписка создаётся в БД, reminders планируются", async () => {
