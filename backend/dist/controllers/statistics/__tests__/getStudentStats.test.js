...
describe("getStudentStatistics integration tests", () => {
    ...
    beforeAll(async () => {
        ...
        const sA = await prisma_1.default.student.create({
            data: { name: "Alice", contactMethod: "WHATSAPP", tutorId: userId },
        });
        const sB = await prisma_1.default.student.create({
    ...
    afterAll(async () => {
        ...
        await prisma_1.default.user.delete({ where: { id: otherUserId } });
    ...
    it("returns aggregated stats per student", async () => {
        ...
        await (0, supertest_1.default)(index_1.app)
            ...
            const a = res.body.studentStatistics.find((s) => s.studentId === studentA);
            const b = res.body.studentStatistics.find((s) => s.studentId === studentB);
    ...
    it("respects date range filters", async () => {
        ...
        await (0, supertest_1.default)(index_1.app)
            ...
            const stat = res.body.studentStatistics.find((s) => s.studentId === studentA);
            if (stat) {
    ...
    it("sums zero prices correctly", async () => {
        const tmp = await prisma_1.default.student.create({
        ...
        await (0, supertest_1.default)(index_1.app)
            ...
            .expect(200)
            .then((res) => {
            const stat = res.body.studentStatistics.find((s) => s.studentId === tmp.id);
        ...
        await prisma_1.default.student.delete({ where: { id: tmp.id } });
    });
    it("handles null prices correctly (mixed and all-null cases)", async () => {
        ...
        const tmp1 = await prisma_1.default.student.create({
            data: { name: "Tmp1", contactMethod: "WHATSAPP", tutorId: userId },
        });
        const tmp2 = await prisma_1.default.student.create({
        ...
        await (0, supertest_1.default)(index_1.app)
            ...
            .expect(200)
            .then((res) => {
            const stat = res.body.studentStatistics.find((s) => s.studentId === tmp1.id);
            expect(stat).toBeDefined();
        ...
        await (0, supertest_1.default)(index_1.app)
            ...
            .expect(200)
            .then((res) => {
            const stat = res.body.studentStatistics.find((s) => s.studentId === tmp2.id);
            expect(stat).toBeDefined();
    ...
    it("handles database errors gracefully", async () => {
        const originalGroupBy = prisma_1.default.lesson.groupBy;
        prisma_1.default.lesson.groupBy = jest
            .fn()
        ...
        await (0, supertest_1.default)(index_1.app)
            ...
            .set("Authorization", `Bearer ${authToken}`)
            .expect(500);
        prisma_1.default.lesson.groupBy = originalGroupBy;
    });
});
//# sourceMappingURL=getStudentStats.test.js.map