...
- `frontend/src` and `backend/src` reformatted with Prettier 3 under the shared config: 318 files, mostly code that had been wrapped at 80 columns under a `printWidth: 100` config. The commit is listed in `.git-blame-ignore-revs` (4c0d538)
